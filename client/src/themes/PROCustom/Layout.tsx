...
// Import GIF assets (place your GIF files in ./assets/ folder)
...
const Layout: React.FC<Props> = ({ theme }) => {
    const blueGradient = {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.headerLeft}>
                <div
                    className={styles.headerInnerLeft} style={blueGradient}>
                    ...
                    <div className={styles.glassPanelLeft}>{theme.glassPanelLeftText}</div>
                </div>
            </div>
            ...
            <div className={styles.headerRight}>
                ...
                >
                    ...
                    <div className={styles.glassPanelRight}>{theme.glassPanelRightText}</div>
                </div>
            </div>
            ...
            <div className={`${styles.circleContainer} ${styles.circleLeft}`}>
                ...
                <div className={styles.circleInner}>
                    {theme.team1Flag && <img src={theme.team1Flag} alt="Team 1" className={styles.flagImage} />}
                </div>
                <svg className={`${styles.ringSvg} ${styles.animateRing}`} viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="46" fill="none" stroke={theme.ringColor} strokeWidth="8" strokeDasharray="100 500" strokeOpacity="1" />
                </svg>
            </div>
            ...
            <div className={`${styles.circleContainer} ${styles.circleRight}`}>
                <div className={styles.circleBorder} style={{ borderColor: theme.ringColor, boxShadow: '0 0 20px rgba(0,0,0,0.5)' }}></div>
                <div className={styles.circleInner}>
                    {theme.team2Flag && <img src={theme.team2Flag} alt="Team 2" className={styles.flagImage} />}
                </div>
            ...
            <div className={styles.lowerThirdsContainer}>
                ...
                <div className={styles.lowerThirdGroup}>
                    <div className={styles.lowerThirdLabel} style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                        <img src={batsman1Gif} alt="Batsman 1" style={{ width: '50px', height: '50px', marginRight: '8px', borderRadius: '4px', objectFit: 'cover' }} />
                ...
                <div className={styles.lowerThirdGroup}>
                    <div className={styles.lowerThirdLabel} style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                        <img src={batsman2Gif} alt="Batsman 2" style={{ width: '50px', height: '50px', marginRight: '8px', borderRadius: '4px', objectFit: 'cover' }} />
                        <span className={styles.lowerThirdLabelText}>BATSMAN</span>
                    </div>
                    <div className={styles.lowerThirdBox}>
                        <div className={styles.lowerThirdContent} style={blueGradient}>
                ...
                <div className={styles.lowerThirdGroup}>
                    <div className={styles.lowerThirdLabel} style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                        <img src={bowlerGif} alt="Bowler" style={{ width: '50px', height: '50px', marginRight: '8px', borderRadius: '4px', objectFit: 'cover' }} />
            ...
            <div className={styles.bottomBar}>
                <div className={styles.bottomBarGradient} style={{ background: `linear-gradient(to right, ${theme.bottomBar1Start}, ${theme.bottomBar1End})` }}></div>
                <div className={styles.bottomBarBlue} style={{ background: `linear-gradient(to right, ${theme.bottomBar2Start}, ${theme.bottomBar2End})` }}></div>
            </div>
