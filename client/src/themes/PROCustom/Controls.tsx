            ...
            <div className="space-y-3 pt-2 border-t border-gray-100">
                ...
                <div className="space-y-3">
                    <div className="flex flex-col gap-1">
                        <label className="text-sm font-medium text-gray-700">Left Header Text</label>
                        <input
                            type="text"
                            value={theme.glassPanelLeftText}
                            onChange={(e) => handleChange('glassPanelLeftText', e.target.value)}
                            className="w-full p-2 border border-gray-300 rounded text-sm"
                            placeholder="e.g. PREMIER LEAGUE"
                        />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label className="text-sm font-medium text-gray-700">Right Header Text</label>
                        <input
                            type="text"
                            value={theme.glassPanelRightText}
                            onChange={(e) => handleChange('glassPanelRightText', e.target.value)}
                            className="w-full p-2 border border-gray-300 rounded text-sm"
