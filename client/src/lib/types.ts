...
export interface ThemeConfig {
  ...
  textBowler: string;
  // Header Texts
  glassPanelLeftText: string;
  glassPanelRightText: string;
...
export const DEFAULT_THEME: ThemeConfig = {
  ...
  glassPanelLeftText: 'PREMIER LEAGUE',
  glassPanelRightText: 'SEASON 2025',
