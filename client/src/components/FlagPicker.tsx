                        ...
                        <div className="p-3 border-b border-gray-100 bg-gray-50 space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    value={selectedFlag.startsWith('http') ? selectedFlag : ''}
                                    onChange={(e) => onSelect(e.target.value)}
                                    className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 placeholder-gray-400"
                                />
                            </div>
                        </div>
